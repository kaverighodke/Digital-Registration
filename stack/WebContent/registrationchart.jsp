...
<body class="content-wrapper">
	...
	EventService service = new EventService();
	 ...
	 total=service.getRegistrationDataService(); */
	%>


	<!-- STACKED BAR CHART -->
	<div class="card card-primary" onload="Draw()">
...
<script type="text/javascript">
	$(function Draw() {
		...
		var areaChartData = {
			labels : ['Project Competition', 'Dance Festival', 'Special Of Special', 'farewell', 'Birthday', 'Poster Making', ,
					'July' ],
			datasets : [ {
				label : 'Self',
				...
				label : 'Corporate',
				backgroundColor : 'rgba(41, 98, 130, 1)',
				borderColor : 'rgba(41, 98, 130, 1)',
				pointRadius : false,
				pointColor : 'rgba(41, 98, 130, 1)',
				pointStrokeColor : '#c1c7d1',
				pointHighlightFill : '#fff',
				pointHighlightStroke : 'rgba(41,98,130,1)',
				data : [ 10, 20, 15, 5, 30, 25, 35 ]
			}, {
				label : 'Others',
				backgroundColor : 'rgba(95, 164, 204, 1)',
				borderColor : 'rgba(95, 164, 204, 1)',
				pointRadius : false,
				pointColor : 'rgba(95, 164, 204, 1)',
				pointStrokeColor : '#c1c7d1',
				pointHighlightFill : '#fff',
				pointHighlightStroke : 'rgba(95, 164, 204, 1)',
				data : [ 65, 59, 80, 81, 56, 55, 40 ]
			}, ]
		}
